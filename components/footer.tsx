    ...
    >
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-12">
          ...
          >
            <h4 className="text-xl font-extrabold font-sans tracking-wide text-blue-950 mb-6" style={{ fontFamily: "var(--font-nunito)" }}>COMPANY</h4>
          ...
          >
            <h4 className="text-xl font-extrabold font-sans tracking-wide text-blue-950 mb-6" style={{ fontFamily: "var(--font-nunito)" }}>SHOP</h4>
            <ul className="space-y-3 text-xs text-gray-600">
              <li>
