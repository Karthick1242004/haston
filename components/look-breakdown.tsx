      ...
      <div className="w-full px-6 md:px-12">
        ...
        >
          <div className="flex flex-wrap items-center gap-8 mb-6">
            <h2 className="text-6xl md:text-8xl mt-4 font-bold tracking-tight text-blue-950" style={{ fontFamily: "var(--font-inter)" }}>
              The{" "}
              Look{" "}
              Breakdown
            </h2>
              ...
              >
                        ...
                        <div className="grid grid-cols-4 gap-2 mx-auto max-w-sm">
                          {carouselItems[safeIndex].sizes.map((size) => (
                            <button
                              ...
                              className={`py-2 px-3 text-sm border rounded transition-all duration-200 font-medium ${selectedSize === size
                ...
                <div className="flex items-center flex-wrap justify-center gap-6 mb-8">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <Heart
                        className={`w-5 h-5 transition-colors ${carouselItems?.length > 0 && isInWishlist(carouselItems[safeIndex]?.id)
                          ? "fill-current"
                          : ""
                          }`}
                      />
